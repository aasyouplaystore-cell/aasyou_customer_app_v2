...
class _NearbyStoresPageState extends State<NearbyStoresPage> {
  ...
  Widget build(BuildContext context) {
    return CustomScaffold(
      showViewCart: true,
      // title: AppLocalizations.of(context)?.nearbyStores ??
      ...
      appBar: AppBar(
        ...
        bottom: PreferredSize(
            preferredSize: const Size.fromHeight(50), child: _buildSearchBar()),
      ),
                ...
                PositionedDirectional(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        const Icon(AppTheme.ratingStarIconFilled,
                            size: 16, color: AppTheme.ratingStarColor),
                        const SizedBox(width: 4),
                        Text(
                            '${rating.toStringAsFixed(1)}/5 ($totalStoreFeedback)',
                            style: TextStyle(
                                fontSize: 13,
                                fontWeight: FontWeight.w600,
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 4),
                      Expanded(
                          child: Container(height: 13, color: Colors.grey)),
                      const SizedBox(width: 8),
