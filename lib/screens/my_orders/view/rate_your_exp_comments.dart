                    ...
                    Row(
                      children: [
                        RatingBarIndicator(
                          ...
                          const Icon(AppTheme.ratingStarIconFilled, color: AppTheme.ratingStarColor),
                        ),
                        SizedBox(width: 8.w),
                        Text(
                    ...
                    Row(
                      children: [
                        RatingBar.builder(
                          ...
                          itemBuilder: (context, _) => const Icon(AppTheme.ratingStarIconFilled, color: AppTheme.ratingStarColor),
